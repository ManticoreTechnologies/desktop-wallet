...
const ManageAssets = (): JSX.Element => {
  ...
  const handleManageAsset = (e: React.FormEvent) => {
    e.preventDefault();
    console.log({
      assetName,
      quantity,
    ...
    // Add your manage asset logic here
  };

  return (
    <div>
      <h1>Manage Asset</h1>
      <form onSubmit={handleManageAsset}>
        <div>
        ...
        <button type="submit">Manage Asset</button>
      </form>
    </div>
  );
};
